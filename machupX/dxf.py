...
# function that determines whether to create a spline dxf file or a line dxf file
def dxf(filename,x,y,z,is_spline = True):

    if is_spline:
        dxf_spline(filename,x,y,z)
    else:
        dxf_line(filename,x,y,z)
    return
