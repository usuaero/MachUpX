...
class Airplane:
    ...
    def export_stp(self, filename, section_resolution=200):
        ...
        with open(filename, 'w') as step_handle:
            ...
            # Header
            step_handle.write("""ISO-10303-21;
HEADER;
FILE_DESCRIPTION ( ( 'STEP AP203' ) , '1' ) ;
FILE_NAME ( '{0}' , '', ('Author'), (''), 'MachUpX', 'MachUpX', 'Unknown' ) ;
FILE_SCHEMA ( '' );
ENDSEC;\n\n""".format(filename))
...
#16 = PRODUCT_DEFINITION_SHAPE ( '{0}' , 'NONE' , #18 ) ;
...
#23 = APPLICATION_CONTEXT ( 'AP 203' ) ;\n""".format(self.name))
            ...
            step_handle.write("\n#101 = ADVANCED_BREP_SHAPE_REPRESENTATION ( 'NONE' , ( {0} ) , #103 ) ;\n".format(", ".join(["#"+str(ind) for ind in solid_indices])))
