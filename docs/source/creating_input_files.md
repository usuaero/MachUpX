...
>>>>
>>>>**"N" : int, optional**
>>>>>Number of outline points to be used for the airfoil, whether generated by MachUpX or given by the user under "outline_points". Should be the same for all airfoils in a wing segment. Defaults to 80.
>>>>
>>>>**"NACA" : str, optional**
